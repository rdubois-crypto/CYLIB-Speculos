...
#include "cy_quad.h"
#include "cy_vecgen_fp2.c"

cy_error_t vecgen_all(cryptolib_ctx_t *cryptolib)
{
	...
	CY_CHECK(vecgen_fp2_unit(cryptolib->mem_unit->Shared_Memory, _FP2_ZONE_T8));
