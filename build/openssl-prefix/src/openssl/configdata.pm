...
our %config = (
  ...
  CFLAGS => [ " -mthumb -W -Wall -fPIC -Wno-unused-parameter -Wno-missing-field-initializers" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/ripemd/build.info", "crypto/blake2/build.info", "crypto/aes/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/ui/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  cflags => [  ],
  ...
  major => "1",
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_ARIA", "OPENSSL_NO_BF", "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_CAST", "OPENSSL_NO_CHACHA", "OPENSSL_NO_CMAC", "OPENSSL_NO_CMS", "OPENSSL_NO_COMP", "OPENSSL_NO_CT", "OPENSSL_NO_DES", "OPENSSL_NO_DH", "OPENSSL_NO_DSA", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MD4", "OPENSSL_NO_MDC2", "OPENSSL_NO_OCSP", "OPENSSL_NO_POLY1305", "OPENSSL_NO_RC2", "OPENSSL_NO_RC4", "OPENSSL_NO_RC5", "OPENSSL_NO_SEED", "OPENSSL_NO_SIPHASH", "OPENSSL_NO_SM2", "OPENSSL_NO_SM3", "OPENSSL_NO_SM4", "OPENSSL_NO_SRP", "OPENSSL_NO_TS", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [ "OPENSSL_MIN_API=0x10100000L" ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_APPS", "OPENSSL_NO_ASAN", "OPENSSL_NO_ASM", "OPENSSL_NO_ASYNC", "OPENSSL_NO_AUTOALGINIT", "OPENSSL_NO_AUTOERRINIT", "OPENSSL_NO_AUTOLOAD_CONFIG", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEPRECATED", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DGRAM", "OPENSSL_NO_DSO", "OPENSSL_NO_DTLS", "OPENSSL_NO_DTLS1", "OPENSSL_NO_DTLS1_2", "OPENSSL_NO_EC2M", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_ECDH", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_ERR", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FILENAMES", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_GOST", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_HW", "OPENSSL_NO_MSAN", "OPENSSL_NO_MULTIBLOCK", "OPENSSL_NO_NEXTPROTONEG", "OPENSSL_NO_OCB", "OPENSSL_NO_PINSHARED", "OPENSSL_NO_POSIX_IO", "OPENSSL_NO_PSK", "OPENSSL_NO_RDRAND", "OPENSSL_NO_RFC3779", "OPENSSL_NO_SCRYPT", "OPENSSL_NO_SCTP", "OPENSSL_NO_SOCK", "OPENSSL_NO_SRTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_STDIO", "OPENSSL_NO_TESTS", "OPENSSL_NO_TLS", "OPENSSL_NO_TLS1", "OPENSSL_NO_TLS1_1", "OPENSSL_NO_TLS1_2", "OPENSSL_NO_TLS1_3", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UI_CONSOLE", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [  ],
  openssldir => "",
  options => "--prefix=/home/dubois/eclipse-workspace/Speculos-blst/speculos/speculos-master/build/install no-afalgeng no-apps no-aria no-asan no-asm no-async no-autoalginit no-autoerrinit no-autoload-config no-bf no-buildtest-c++ no-camellia no-capieng no-cast no-chacha no-cmac no-cms no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-ct no-deprecated no-des no-devcryptoeng no-dgram no-dh no-dsa no-dso no-dtls no-dtls1 no-dtls1_2 no-dynamic-engine no-ec2m no-ec_nistp_64_gcc_128 no-ecdh no-egd no-engine no-err no-external-tests no-filenames no-fuzz-afl no-fuzz-libfuzzer no-gost no-heartbeats no-hw no-idea no-makedepend no-md2 no-md4 no-mdc2 no-msan no-multiblock no-nextprotoneg no-ocb no-ocsp no-pinshared no-poly1305 no-posix-io no-psk no-rc2 no-rc4 no-rc5 no-rdrand no-rfc3779 no-scrypt no-sctp no-seed no-shared no-siphash no-sm2 no-sm3 no-sm4 no-sock no-srp no-srtp no-sse2 no-ssl-trace no-ssl3 no-ssl3-method no-stdio no-tests no-threads no-tls no-tls1 no-tls1_1 no-tls1_2 no-tls1_3 no-ts no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.30.0",
  perlargv => [ "CC=arm-linux-gnueabihf-gcc", "CFLAGS= -mthumb -W -Wall -fPIC -Wno-unused-parameter -Wno-missing-field-initializers", "no-afalgeng", "no-aria", "no-asan", "no-asm", "no-async", "no-autoalginit", "no-autoerrinit", "no-autoload-config", "no-bf", "no-buildtest-c++", "no-camellia", "no-capieng", "no-cast", "no-chacha", "no-cmac", "no-cms", "no-comp", "no-crypto-mdebug", "no-crypto-mdebug-backtrace", "no-ct", "no-deprecated", "no-des", "no-devcryptoeng", "no-dgram", "no-dh", "no-dsa", "no-dso", "no-dtls", "no-ec2m", "no-ecdh", "no-egd", "no-engine", "no-err", "no-external-tests", "no-filenames", "no-fuzz-afl", "no-fuzz-libfuzzer", "no-gost", "no-heartbeats", "no-hw", "no-idea", "no-makedepend", "no-md2", "no-md4", "no-mdc2", "no-msan", "no-multiblock", "no-nextprotoneg", "no-ocb", "no-ocsp", "no-pinshared", "no-poly1305", "no-posix-io", "no-psk", "no-rc2", "no-rc4", "no-rc5", "no-rdrand", "no-rfc3779", "no-scrypt", "no-sctp", "no-seed", "no-shared", "no-siphash", "no-sm2", "no-sm3", "no-sm4", "no-sock", "no-srp", "no-srtp", "no-sse2", "no-ssl", "no-ssl3-method", "no-ssl-trace", "no-stdio", "no-tests", "no-threads", "no-tls", "no-ts", "no-ubsan", "no-ui-console", "no-unit-test", "no-whirlpool", "no-zlib", "no-zlib-dynamic", "linux-armv4", "--prefix=/home/dubois/eclipse-workspace/Speculos-blst/speculos/speculos-master/build/install" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/dubois/eclipse-workspace/Speculos-blst/speculos/speculos-master/build/install",
  processor => "",
  rc4_int => "unsigned char",
  sdirs => [ "objects", "md5", "sha", "hmac", "ripemd", "blake2", "aes", "modes", "bn", "ec", "rsa", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ui", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %disabled = (
  ...
  "cms" => "option",
  "comp" => "option",
  "crypto-mdebug" => "option",
  "crypto-mdebug-backtrace" => "option",
  "ct" => "option",
  "deprecated" => "option",
  "des" => "option",
  "devcryptoeng" => "option",
